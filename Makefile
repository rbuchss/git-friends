...
DOCKER_IMAGE_NAME := rbuchss/git-friends-tester-local
DOCKER_BUILD_TARGET := git-friends-tester-local
...
# Both use comma delimiters: TEST_PATH=test/a.bats,test/b.bats FILTER_TAGS=git::cd,git::logger
...
#   make test FILTER_TAGS=git::logger
#   make test FILTER_TAGS=git::logger,git::cd
define test-command
